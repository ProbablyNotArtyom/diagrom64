...
.segment "SCREEN"
VB0:
	scrcode "UCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCI"
	scrcode "Bc64 diagrom v0.1             notartyomB"
	scrcode "B--------------------------------------B"
	scrcode "Bram test: ....                        B"
	scrcode "B                                      B"
	scrcode "B                                      B"
	...
	scrcode "B                                      B"
	scrcode "B                                      B"
	scrcode "B                          UC",$B2,"CCC",$B2,"C",$B2,"CCC", $B3
	scrcode "B                          B Bu21B Bu9 B"
	scrcode "B                          B Bu22B Bu10B"
	scrcode "B                          B Bu23B Bu11B"
	scrcode "B                          B Bu24B Bu12B"
	scrcode "JCCCCCCCCCCCCCCCCCCCCCCCCCC",$B1,"C",$B1,"CCC",$B1,"C",$B1,"CCCK"
